...
import functional.chapter08.Chapter08Exercise05.Student
import functional.chapter08.Chapter08Exercise05.makePassingStudentsList
import kotlin.test.Test
import kotlin.test.assertEquals

class Chapter08Exercise05Test {
    private val internshipStudent = Student("Marc", "Smith", 87.0, 32)
    private val studentWithTooLowResultToInternship = Student("Marcus", "Smith", 37.0, 32)
    private val studentWithNotEnoughPointsForInternship = Student("Marcello", "Smith", 87.0, 12)
    private val studentNotPassingBecauseOfResult = Student("Peter", "Jackson", 21.0, 24)
    private val studentNotPassingBecauseOfPoints = Student("Michael", "Angelo", 71.0, 12)

    private val allStudents =
        listOf(
            internshipStudent,
